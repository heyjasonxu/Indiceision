    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent yesGoodButton = new Intent(getApplicationContext(),Profile.class);//TODO: Change to Profile
                Intent yesBadButton = new Intent(getApplicationContext(),Profile.class);//TODO: Change to Profile
